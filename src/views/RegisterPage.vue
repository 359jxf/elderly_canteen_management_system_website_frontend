  ...
  <div class="container">
    <div class="info-wrapper">
      ...
      <div class="login-wrapper">
        <div class="msg"><a :href="backLink">← 返回登录</a></div>
  ...
  computed: {
    backLink() {
      ...
      if (from === "login") {
        ...
        return "/OTP"; // 假设你有一个名为/otpLogin的路由
      }
      // 默认返回，或者处理其他情况
      return "/login";
    },
...
>>>>>>> 730260bfed70d6011eaea10a3debeb8728d1255c
        return;
      }
